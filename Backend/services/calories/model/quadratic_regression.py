...
Y = calories_data['Calories'].to_numpy().reshape(-1,1)
...
X_train_pl = mq6_poly.fit_transform(X_train)
X_test_pl = mq6_poly.fit_transform(X_test)
...
print("RMSE:", rmse)
print("Train - MAE:", metrics.mean_absolute_error(Y_train, train_data_prediction))
